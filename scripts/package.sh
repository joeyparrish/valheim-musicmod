...
# Make a generic zip.
rm -rf staging MusicMod.zip
mkdir -p staging/plugins
# Stage mod & assets.
cp MusicMod/bin/Release/MusicMod.dll staging/plugins/
# Stage mod metadata.
...
# Zip it.
(cd staging; zip -r9 ../MusicMod.zip *)
...
dll_version=$(monodis --assembly staging/plugins/MusicMod.dll \
